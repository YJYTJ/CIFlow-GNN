...
class CIFlow(nn.Module):
    def __init__(self,args,input_dim, output_dim ):
        ...
        self.concat_mlp = MLP(2,self.power_num+1 , latent_dim2,1 )
        ...
        self.correlation_MLP = MLP(2,self.num_graph_filter,self.num_graph_filter,  self.num_graph_filter)
    ...
    def forward(self, W, features, targets, graph_indicator):
        ...
        out = {"pred1":pred1,"pred2":pred2,"S":S_all,"H":H_all,"ind_positive_sample":ind_positive_sample,"E_all":E_all,"feature_mask":feature_mask,"Q":Q}
